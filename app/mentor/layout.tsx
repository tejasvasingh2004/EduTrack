    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 flex">
      <aside className="w-64 border-r border-white/10 bg-white/5 backdrop-blur-xl flex flex-col hidden md:flex relative z-20">
        <div className="h-16 flex items-center px-6 border-b border-white/10">
          <div className="font-bold text-xl bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-400">
            Mentor Portal
          </div>
        </div>
        
        <nav className="flex-1 py-6 px-4 space-y-2">
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-600/20 text-emerald-400 border border-emerald-500/30">
            <BookOpen className="w-5 h-5" />
            <span className="font-medium">My Mentees</span>
          </div>
      ...
      <main className="flex-1 overflow-auto p-8 relative">
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-emerald-600/10 blur-[120px] pointer-events-none" />
